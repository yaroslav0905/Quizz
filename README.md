...
+ изменение property внутри структуры mutating

Самостотельная радота
+ изменил структуру Quizz из встроенных двух вопросов(true/false) на 3 прописанных в структуре
